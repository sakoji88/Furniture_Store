...
- Каталог в виде карточек интернет-магазина (изображение, цена, действия)
- Админка: управление пользователями (бан/разбан/повышение), CRUD товаров и категорий
- Корзина и оформление заказа
- Профиль пользователя с историей заказов и статусами
- Админское управление статусами заказов
